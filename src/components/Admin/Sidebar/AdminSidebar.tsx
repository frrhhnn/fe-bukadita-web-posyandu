      ...
      <div className="p-4 flex-1 overflow-auto">
        <nav className="space-y-3">
          <Link
            href="/admin"
            className={`${itemBase} ${
              isActive("/admin") ? itemActive : itemHover
            }`}
          >
          ...
          <Link
            href="/admin/pengguna"
            className={`${itemBase} ${
              isActive("/admin/pengguna") ? itemActive : itemHover
            }`}
          >
          ...
          <div className="pt-2">
            <button
              onClick={() => setOpenBayi((v) => !v)}
              className="w-full flex items-center justify-between font-medium text-slate-100 px-3 py-2 rounded-md hover:bg-white/6"
            >
            ...
            {openBayi && (
              <div className="mt-2 pl-6 flex flex-col gap-1">
                <Link
                  href="/admin/bayi-balita/materi"
                  className={`${itemBase} text-slate-100 text-sm ${
                    isActive("/admin/bayi-balita/materi")
                      ? itemActive
                      : itemHover
                  }`}
                >
                ...
                <Link
                  href="/admin/bayi-balita/kuis"
                  className={`${itemBase} text-slate-100 text-sm ${
                    isActive("/admin/bayi-balita/kuis") ? itemActive : itemHover
                  }`}
                >
          ...
          <div className="pt-2">
            ...
            {openRemaja && (
              <div className="mt-2 pl-6 flex flex-col gap-1">
                <Link
                  href="/admin/sekolah-remaja/materi"
                  className={`${itemBase} text-slate-100 text-sm ${
                    isActive("/admin/sekolah-remaja/materi")
                      ? itemActive
                      : itemHover
                  }`}
                >
                ...
                <Link
                  href="/admin/sekolah-remaja/kuis"
                  className={`${itemBase} text-slate-100 text-sm ${
                    isActive("/admin/sekolah-remaja/kuis")
                      ? itemActive
                      : itemHover
                  }`}
                >
          ...
          <div className="pt-2">
            ...
            {openIbuHamil && (
              <div className="mt-2 pl-6 flex flex-col gap-1">
                <Link
                  href="/admin/hamil-menyusui/materi"
                  className={`${itemBase} text-slate-100 text-sm ${
                    isActive("/admin/hamil-menyusui/materi")
                      ? itemActive
                      : itemHover
                  }`}
                >
                ...
                <Link
                  href="/admin/hamil-menyusui/kuis"
                  className={`${itemBase} text-slate-100 text-sm ${
                    isActive("/admin/hamil-menyusui/kuis")
                      ? itemActive
                      : itemHover
                  }`}
                >
          ...
          <div className="pt-2">
            <button
              onClick={() => setOpenDewasaLansia((v) => !v)}
              className="w-full flex items-center justify-between font-medium text-slate-100 px-3 py-2 rounded-md hover:bg-white/6"
            >
              <div className="flex items-center gap-3">
            ...
            {openDewasaLansia && (
              <div className="mt-2 pl-6 flex flex-col gap-1">
                <Link
                  href="/admin/dewasa-lansia/materi"
                  className={`${itemBase} text-slate-100 text-sm ${
                    isActive("/admin/dewasa-lansia/materi")
                      ? itemActive
                      : itemHover
                  }`}
                >
                ...
                <Link
                  href="/admin/dewasa-lansia/kuis"
                  className={`${itemBase} text-slate-100 text-sm ${
                    isActive("/admin/dewasa-lansia/kuis")
                      ? itemActive
                      : itemHover
                  }`}
                >
