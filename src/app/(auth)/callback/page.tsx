      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-center">
          <div className="relative">
            <div className="w-16 h-16 border-4 border-[#578FCA]/20 border-t-[#27548A] rounded-full animate-spin"></div>
            <div className="absolute inset-0 w-16 h-16 border-4 border-transparent border-r-[#578FCA] rounded-full animate-spin animation-delay-150"></div>
          </div>
        </div>

        {/* Loading Text */}
        <div className="space-y-2">
          <h1 className="text-2xl font-bold text-[#27548A] font-poppins">
